...
| P4 | Resolve the repaired hand-wipe finishing and family-montage compiler results | The hand-wipe compiler was preferred but its assembled palm transition failed; valid full-palm coverage exists for a no-cost deterministic re-trim. The operator selected the family control but has not yet said whether the compiler candidate was materially worse or still commercially acceptable | Operator review of the no-cost hand-wipe transition repair and calibration on family Candidate B; only a material family failure should trigger another compiler change and fresh spend request |
