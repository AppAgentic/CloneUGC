...
| P4 | Resolve the repaired family-montage compiler result | The hand-wipe compiler won the repaired retest with one minor palm-transition finding. The operator selected the family control but has not yet said whether the compiler candidate was materially worse or still commercially acceptable | Operator calibration on family Candidate B; if materially worse, attribute a typed repair and obtain a fresh bounded approval only after another compiler change |
